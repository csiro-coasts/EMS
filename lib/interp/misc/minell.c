 ...
 *
 *  File: model/lib/grid/misc/minell.c
 *  
 ...
 *
 *  $Id: minell.c 6594 2020-09-03 03:32:21Z riz008 $
 *
 */
...
static void minell_findfifthpoint(minell* me)
{
     ...
     */
    {
        ...
        for (i = 0; i < 4; ++i) {
            int i1 = (i + 1) % 4;
            double dist = points_distance_xy(ps[i], ps[i1]);
...
{
    point** pp = points_shuffle(n, p, me_seed);
