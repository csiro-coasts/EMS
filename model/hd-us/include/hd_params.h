 ...
 *  
 *  File: model/hd-us/include/hd_params.h
 *  
 *  Description:
...
#define ORDER4        0x000008
#define QUICKEST      0x000010
#define VANLEER       0x000020
#define LAGRANGE      0x000040
#define HIORDER       0x000080
#define EXPLICIT      0x000100
#define WIMPLICIT     0x000200
#define ORDER2_UW     0x000400
#define ADVECT_FORM   0x000800
#define WTOP_O2       0x001000
#define WTOP_O4       0x002000
#define ZERO_DRYK     0x004000
#define SHAPIRO       0x008000
#define FFSL          0x010000
#define RINGLER       0x020000
#define FCT           0x040000
...
#define RECT_DXY_ROT      0x0001
#define GRECT_DXY_ROT     0x0002
#define GRECT_DLATLON_ROT 0x0004
#define GRECT_DLATLON_FP  0x0008
#define POLAR_DARC_ROT    0x0010
#define ELLIPTIC_DTAU_ROT 0x0020
#define NUMERICAL         0x0040
#define UNSTRUCTURED      0x0080
#define GTRI_DXY_ROT      0x0100
#define GTRI_DLATLON_FP   0x0200
#define TRI_DXY_ROT       0x0400
...
#define US_QUAD    0x0002
#define US_HEX     0x0004
#define US_G       0x0008   /* -g mode                */
#define US_P       0x0010   /* -p mode                */
#define US_WS      0x0020   /* Write structured       */
#define US_WUS     0x0040   /* Write unstructured     */
#define US_RS      0x0080   /* Read structured        */
#define US_RUS     0x0100   /* Read unstructured      */
#define US_IJ      0x0200   /* (i,j) indices supplied */
...
#define ST_SQ3     0x002
#define ST_SIZED   0x004
#define ST_CENT    0x008
#define ST_EDGE    0x010
#define ST_ALLE    0x020
#define ST_SIZEO   0x040

/* Velocity gradient */
#define GRAD_2D    0x001
#define GRAD_3D    0x002
#define GRAD_NOR   0x004
#define GRAD_TAN   0x008

/* Mesh output summary */
#define M_BOUND_HFUN   1
#define M_CREATE_JIG   2
#define M_CONVERT_JIG  4
#define M_MESHSTRUCT   8

/* Unstructured bathymetry filling */
#define B_REMOVE       1
#define B_MINIMUM      2
#define B_AVERAGE      4
