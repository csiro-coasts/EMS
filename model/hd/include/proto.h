...
void get_local_maps(geometry_t *window, int wn, int *wsa, int wsize,
...
void local_map_build_o(int c, int cc, int wn, int *map, int *nmap,
                     int *rmap, int *wsa, int *ac, int nsaux, int zoomf);
void get_local_wsa(int *vec, int nvec, int nvec2D, geometry_t **window,
                   int nwindows, int compatible, int mode);
...
void window_cells_block_e2(geometry_t *geom, int nwindows, int **ws2,
			   int *wsizeS, int os);
int reset_map(int cm, int wn, int *wsa, int *al);
void reorder_gl_map(int wn, int *wsa, int wsize, int *mask, int msize);
void wsa_cells(geometry_t *window, int *loc3, int *loc2, int c,
               short *mask, int mode);
void surfbot_build(geometry_t *window, int wn, int *sur, int *bot,
                   int *vec, int nvec, int *vec2D, int nvec2D,
                   int avec2D, int mode);
void aux_maps(geometry_t *window, int cc);
...
void OBC_build(open_bdrys_t **open, geometry_t **window, int nwindows);
...
void bdry_eval_tr_w(geometry_t *geom, master_t *master, geometry_t *window);
void bdry_eval_u1_w(geometry_t *geom, master_t *master, geometry_t *window);
void bdry_eval_u2_w(geometry_t *geom, master_t *master, geometry_t *window);
...
void bdry_eval_eta_w(geometry_t *geom, master_t *master, geometry_t *window);
void bdry_eval_u1av_w(geometry_t *geom, master_t *master, geometry_t *window);
void bdry_eval_u2av_w(geometry_t *geom, master_t *master, geometry_t *window);
...
void set_sponge_m(geometry_t *geom, master_t *master);
void set_sponge_w(geometry_t *window, window_t *windat, win_priv_t *wincon);
void set_sponge(geometry_t *window, double *u1vh, double *u2vh,
		double dt, double *mask);
...
void u2av_local(geometry_t *window, window_t *windat, win_priv_t *wincon,
		open_bdrys_t *open, double *val, int sb, int eb, int dir);
...
void win_data_buffered_recv_refill_2d(master_t *master, geometry_t *window,
				      window_t *windat, int nwindows, int mode);
void win_data_buffered_empty(master_t *master, geometry_t *window,
			     window_t *windat, int mode);
...
void unpack_sparse(int *map, int mapsize, double *var, double *pack);
...
double con_mean(geometry_t *window, double *vel, double velmax, int c);
double con_median(geometry_t *window, double *vel, double velmax, int c);
...
void advect(geometry_t *window, window_t *windat, win_priv_t *wincon,
            double *tr, double *Fx, double *Fy, double *Fz, 
	    double *tr_mod, double *tr_mod_x, double *tr_mod_y, double *tr_mod_z, double dtu);
...
double surf_conc(geometry_t *window, window_t *windat, win_priv_t *wincon,
                 double *tr, double subeta, int c, int c2, int cc,
...
int get_icell(geometry_t *window, int cl, int cg, int ci);
...
void ulimate_filter(double *cr, double *Fx, double *F, int *ctp, int vs,
                    int ve, int *mapm, int *mapp);
...
void order1(geometry_t *window, window_t *windat, win_priv_t *wincon,
            double *tr, double *Fx, double *Fy, double *Fz, double dtu);
void order2(geometry_t *window, window_t *windat, win_priv_t *wincon,
            double *tr, double *Fx, double *Fy, double *Fz);
void order2_do(double *F, double *tr, double *mgs, int ss, int se,
               int *sdo, int *bmap, int *m2d);
void order4(geometry_t *window, window_t *windat, win_priv_t *wincon,
            double *tr, double *Fx, double *Fy, double *Fz);
void order4_do(double *F, double *tr, int ss, int se, int *sdo,
               int *bmap, int *fmap);
...
void van_leer(geometry_t *window, window_t *windat, win_priv_t *wincon,
              double *tr, double *Fx, double *Fy, double *Fz);
void van_leer_do(double *F, double *tr, double *vel, double *cn, int ss,
                 int se, int *sdo, int *fmap, int *bmap);
void prep_ff_sl(geometry_t *window, window_t *windat, win_priv_t *wincon,
	       double dt);
void ff_sl(geometry_t *window, window_t *windat, win_priv_t *wincon,
	  double *tr, double *Fx, double *Fy, double *Fz, double dt);
void ff_sl3d(geometry_t *window, window_t *windat, win_priv_t *wincon,
	    double *tr, double *Fx, double *Fy, double *Fz, 
	     double *tr_mod, double *tr_mod_x, double *tr_mod_y, double *tr_mod_z, double dt);
void ff_sl_do_hor(double *vel, double dt, double *h, int *m2d, int ss,
...
void ff_sl_order1(geometry_t *window, double *F, double *tr, double *vel, double *crf,
		  int *cl, int ss, int se, int *sdo, int *fmap, int *bmap);
...
void order2_upwind_do(double *F, double *tr, double *vel, double *cn, 
		      int ss, int se, int *sdo, int *fmap, int *bmap);
...
void update_flux(geometry_t *window, window_t *windat, win_priv_t *wincon,
                 double *Fx, double *Fy, double *Fz, double dtu);
...
void calc_flux(geometry_t *window, window_t *windat, win_priv_t *wincon, 
	       double *fluxe1, double *fluxe2, double *fluxw, double dt);
...
void hvisc_u2_3d(geometry_t *window, window_t *windat, win_priv_t *wincon);
...
void reset_hdiff(geometry_t *window, int cl, int mode);
void set_hdiff(geometry_t *window, double *AH, double AH0, int mode);
...
void velocity_adjust(geometry_t *window, window_t *windat,
                     win_priv_t *wincon);
void velocity_adjust_weighted(geometry_t *window, window_t *windat,
            win_priv_t *wincon);
void velocity_adjust_weighted_r(geometry_t *window, window_t *windat,
            win_priv_t *wincon);
...
void vel_w_bounds_hiorder(geometry_t *window, window_t *windat, win_priv_t *wincon);
...
int dump_open(parameters_t *params, char *name, int check);
...
int dump_re_read(master_t *master, 
		 int cdfid, int ti);
int dumpdata_read(geometry_t *geom, parameters_t *params, master_t *master,
...
double cvol1(master_t *master, double *a, int c);
double cvol1w(geometry_t *window, double *a, int c);
void smooth_w(geometry_t *window, double *A, double *B,
	      int *ctp, int nctp, int n, double lim);
void shapiro(geometry_t *window, double *a, double *buf, int *vec, 
	     int nvec, int order, int dir);
void shuman_smooth(geometry_t *window, double *a, int cl);
void shapiro_smoothx(geometry_t *window, double *a, int cl);
void shapiro_smoothy(geometry_t *window, double *a, int cl);
double shapiro_smoothxr(geometry_t *window, double *a, int cl);
double shapiro_smoothyr(geometry_t *window, double *a, int cl);
