 ...
 *  
 *  File: model/hd/include/boundary.h
 *  
 *  Description:
...
struct bdryfn_map {
  ...
  bdrycustom_m func_mw;         /* Evaluation function on MPI slave */
...
struct bdry_details {
  ...
  bdrycustom_m custom_mw;       /* Custom function for the MPI slave */
...
struct open_bdrys {
  ...
  int *nmap;                    /* Map in an interior direction normal to bdry */
  int *omap;                    /* Map in an exterior direction normal to bdry */
  ...
  tidal_consts_t tc;            /* Tidal harmonic elevation structure */
  tidal_consts_t t1u;           /* Tidal harmonic u normal velocity structure */
  tidal_consts_t t1v;           /* Tidal harmonic v normal velocity structure */
  tidal_consts_t t2u;           /* Tidal harmonic u tangential velocity structure */
  tidal_consts_t t2v;           /* Tidal harmonic v tangential velocity structure */
