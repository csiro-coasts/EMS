...
void write_private_eco(FILE *fp, trinfo_priv_eco_t *data, int mode)
{
  ...
  if (strlen(data->specresp3d_name))
    fprintf(fp, "    .specresp3d_name = %s,\n", data->specresp3d_name);
  if (strlen(data->specresp2d_name))
    fprintf(fp, "    .specresp2d_name = %s,\n", data->specresp2d_name);
  if (mode)
    fprintf(fp, "  },\n");
  else
    fprintf(fp, "  }\n");
...
void copy_hydroparameter_info(parameters_t *params, parameters_t *in) {
  ...
  */
  ...
  params->sue2 = in->sue2;
  params->kue2 = in->kue2;
  params->bsue2 = in->bsue2;
  params->bkue2 = in->bkue2;
