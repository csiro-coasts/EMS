 ...
 *  
 *  File: model/hd/outputs/writeatts.c
 *  
 *  Description:
			   ...
			   char *tunit)
{
  ...
  /* Landfill maps */
  vid = ncw_var_id(cdfid, "fmap_i");
  if (vid > -1) {
    write_text_att(cdfid, vid, "units", "cell num");
    write_text_att(cdfid, vid, "long_name", "I coordinate of nearest wet cell");
    write_text_att(cdfid, vid, "coordinates", "x_centre, y_centre, k_centre");
  }
  vid = ncw_var_id(cdfid, "fmap_j");
  if (vid > -1) {
    write_text_att(cdfid, vid, "units", "cell num");
    write_text_att(cdfid, vid, "long_name", "J coordinate of nearest wet cell");
    write_text_att(cdfid, vid, "coordinates", "x_centre, y_centre, k_centre");
  }
