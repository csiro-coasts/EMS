 ...
 *  
 *  $Id: ecology_tracer_defaults.c 7141 2022-06-21 23:03:07Z bai155 $
 *
 */
...
/* Initial conditions that depend on the parameters chosen */
  ...
  eco_def_t eco_def[] = {
    ...
    {"Porewater_Age",       "d",        0.0,    0.0,      0, 1, 1, 5, 1, 0, 1, 1, 0, NOGRAD, ECOLOGY|PROGNOSTIC},
    ...
    {"CS_N_free",      "mg N m-3",  CS_N,         CS_N, 0, 1, 1, 5, 0, 1, 1, 1, 0, FILEIN, ECOLOGY|PROGNOSTIC},
    {"CS_NR_free",      "mg N m-3",  CS_N/2.0,CS_N/2.0, 0, 1, 1, 5, 0, 1, 1, 1, 0, FILEIN, ECOLOGY|PROGNOSTIC},
    {"CS_PR_free",      "mg P m-3",  CS_N/16.0*32.0/14.0,CS_N/16.0*32.0/14.0,0, 1, 1, 5, 0, 1, 1, 1, 0, FILEIN, ECOLOGY|PROGNOSTIC},
    {"CS_I_free",      "mmol photon m-3", CS_N/14.0*1060.0/16.0,CS_N/14.0*1060.0/16.0,0, 1, 1, 5, 0, 1, 1, 1, 0, FILEIN, ECOLOGY|PROGNOSTIC},
    {"CS_Chl_free",    "mg Chl m-3",CS_Chl,CS_Chl,0, 1, 1, 5, 0, 1, 1, 1, 0, FILEIN, ECOLOGY|PROGNOSTIC},
    {"CS_Xh_free",    "mg Xan m-3",CS_Chl/4.0,CS_Chl/4.0,0, 1, 1, 5, 0, 1, 1, 1, 0, FILEIN, ECOLOGY|PROGNOSTIC},
    {"CS_Xp_free",    "mg Xan m-3",CS_Chl/4.0,CS_Chl/4.0,0, 1, 1, 5, 0, 1, 1, 1, 0, FILEIN, ECOLOGY|PROGNOSTIC},
    {"CS_Qred_free",   "umol RCII m-3",CS_Chl*0.002/893.49/3.0,CS_Chl*0.002/893.49/3.0, 0, 1, 1, 5, 0, 1, 1, 1, 0, FILEIN, ECOLOGY|PROGNOSTIC},
    {"CS_Qox_free",    "umol RCII m-3",CS_Chl*0.002/893.49/3.0,CS_Chl*0.002/893.49/3.0, 0, 1, 1, 5, 0, 1, 1, 1, 0, FILEIN, ECOLOGY|PROGNOSTIC},
    {"CS_Qi_free",    "umol RCII m-3",CS_Chl*0.002/893.49/3.0,CS_Chl*0.002/893.49/3.0,0, 1, 1, 5, 0, 1, 1, 1, 0, FILEIN, ECOLOGY|PROGNOSTIC},
    {"CS_RO_free",    "umol ROS m-3",0.0*CS_Chl/3.0,0.0*CS_Chl/3.0, 0, 1, 1, 5, 0, 1, 1, 1, 0, FILEIN, ECOLOGY|PROGNOSTIC},
    ...
    {"Tricho_PEB",    "mg PB m-3",Mic_Chl/4.0,Mic_Chl/4.0,0, 1, 1, 5, 0, 1, 1, 1, 0, FILEIN, ECOLOGY|PROGNOSTIC},
    {"Tricho_PUB",    "mg PB m-3",Mic_Chl/4.0,Mic_Chl/4.0,0, 1, 1, 5, 0, 1, 1, 1, 0, FILEIN, ECOLOGY|PROGNOSTIC},
    {"Tricho_Qred",   "umol RCII m-3",Mic_Chl*0.002/893.49/3.0,Mic_Chl*0.002/893.49/3.0, 0, 1, 1, 5, 0, 1, 1, 1, 0, FILEIN, ECOLOGY|PROGNOSTIC},
    {"Tricho_Qox",    "umol RCII m-3",Mic_Chl*0.002/893.49/3.0,Mic_Chl*0.002/893.49/3.0, 0, 1, 1, 5, 0, 1, 1, 1, 0, FILEIN, ECOLOGY|PROGNOSTIC},
    {"Tricho_Qi",    "umol RCII m-3",Mic_Chl*0.002/893.49/3.0,Mic_Chl*0.002/893.49/3.0,0, 1, 1, 5, 0, 1, 1, 1, 0, FILEIN, ECOLOGY|PROGNOSTIC},
    ...
    {"Ed_440",    "W m-2 nm-1",        0,     0,       2, 0, 0, 5, 0, 0, 1, 1, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"Ed_490",    "W m-2 nm-1",        0,     0,       2, 0, 0, 5, 0, 0, 1, 1, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"Ed_550",    "W m-2 nm-1",        0,     0,       2, 0, 0, 5, 0, 0, 1, 1, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"Ed_670",    "W m-2 nm-1",        0,     0,       2, 0, 0, 5, 0, 0, 1, 1, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"bb_700",    "m-1",        0,     0,       2, 0, 0, 5, 0, 0, 1, 1, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"Zenith2D_col", "rad", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"SWR_bot_abs_col", "-", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"PAR_col",     "mol photon m-2 s-1", 0.0,0.0,  2, 0, 0, 5, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"PAR_hyd",     "mol photon m-2 s-1", 0.0,0.0,  2, 0, 0, 5, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"PAR_z_col","mol photon m-2 s-1", 0.0,0.0,  2, 0, 0, 5, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"Kd_490_col",    "m-1",        0,     0,       2, 0, 0, 5, 0, 0, 1, 1, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"PhyL_yCfac",    "-",        0,     0,       0, 0, 0, 5, 0, 0, 1, 1, 1, NOGRAD, ECOLOGY|PROGNOSTIC},
    {"PhyL_kI",    "mol cell-1",        0,     0,       0, 0, 0, 5, 0, 0, 1, 1, 1, NOGRAD, ECOLOGY|PROGNOSTIC},
    {"PhyS_yCfac",    "-",        0,     0,       0, 0, 0, 5, 0, 0, 1, 1, 1, NOGRAD, ECOLOGY|PROGNOSTIC},
    {"PhyS_kI",    "mol cell-1",        0,     0,       0, 0, 0, 5, 0, 0, 1, 1, 1, NOGRAD, ECOLOGY|PROGNOSTIC},
    {"PhyD_yCfac",    "-",        0,     0,       0, 0, 0, 5, 0, 0, 1, 1, 1, NOGRAD, ECOLOGY|PROGNOSTIC},
    {"PhyD_kI",    "mol cell-1",        0,     0,       0, 0, 0, 5, 0, 0, 1, 1, 1, NOGRAD, ECOLOGY|PROGNOSTIC},
    {"Tricho_yCfac",    "-",        0,     0,       0, 0, 0, 5, 0, 0, 1, 1, 1, NOGRAD, ECOLOGY|PROGNOSTIC},
    {"Tricho_kI",    "mol cell-1",        0,     0,       0, 0, 0, 5, 0, 0, 1, 1, 1, NOGRAD, ECOLOGY|PROGNOSTIC},
    {"MPB_yCfac",    "-",        0,     0,       0, 0, 0, 5, 0, 0, 1, 1, 1, NOGRAD, ECOLOGY|PROGNOSTIC},
    {"MPB_kI",    "mol cell-1",        0,     0,       0, 0, 0, 5, 0, 0, 1, 1, 1, NOGRAD, ECOLOGY|PROGNOSTIC},
    {"MA_kI",  "mol m-2", 0.0,   0.0,    0, 0, 0, 2, 0, 0, 0, 0, 1, NOGRAD, ECOLOGY|PROGNOSTIC},
    {"SG_kI",  "mol m-2", 0.0,   0.0,    0, 0, 0, 2, 0, 0, 0, 0, 1, NOGRAD, ECOLOGY|PROGNOSTIC},
    {"SGH_kI",  "mol m-2", 0.0,   0.0,    0, 0, 0, 2, 0, 0, 0, 0, 1, NOGRAD, ECOLOGY|PROGNOSTIC},
    {"SGD_kI",  "mol m-2", 0.0,   0.0,    0, 0, 0, 2, 0, 0, 0, 0, 1, NOGRAD, ECOLOGY|PROGNOSTIC},
    {"SGP_kI",  "mol m-2", 0.0,   0.0,    0, 0, 0, 2, 0, 0, 0, 0, 1, NOGRAD, ECOLOGY|PROGNOSTIC},
    {"CS_kI",  "mol cell-1", 0.0,   0.0,    0, 0, 0, 2, 0, 0, 0, 0, 1, NOGRAD, ECOLOGY|PROGNOSTIC},
    {"CS_yCfac",  "-", 0.0,   0.0,    0, 0, 0, 2, 0, 0, 0, 0, 1, NOGRAD, ECOLOGY|PROGNOSTIC},
    {"Ref470_col",  "sr-1", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"Ref490_col",  "sr-1", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"Ref590_col",  "sr-1", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"K_heat_col",     "m-1",    0.0,   0.0,        2, 0, 0, 5, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"Moonlight_col", "W m-2", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"Lunar_zenith_col", "radians", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"Lunar_phase_col", "radians", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"Moon_fulldisk_col", "W m-2", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"Secchi_col", "m", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"Sentinel_3B_B3",  "sr-1", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"Sentinel_3B_B4",  "sr-1", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"Sentinel_3B_B5",  "sr-1", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"Sentinel_3B_B6",  "sr-1", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"Sentinel_3B_B8",  "sr-1", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"Sentinel_3B_B11",  "sr-1", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"OC4Me_col",  "mg m-3", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"MODIS_B2",  "sr-1", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"MODIS_B4",  "sr-1", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"MODIS_B6",  "sr-1", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"OC3M_col",  "mg m-3", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"VIIRS_B2",  "sr-1", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"VIIRS_B3",  "sr-1", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"VIIRS_B4",  "sr-1", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"OC3V_col",  "mg m-3", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"Hue_S3B", "degrees", 0.0,   0.0,    2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|DIAGNOSTIC},
    {"EpiPAR_sg_col",  "mol photon m-2 d-1", 0.0, 0.0, 2, 0, 0, 2, 0, 0, 0, 0, 0, NOGRAD, ECOLOGY|PROGNOSTIC},
