...
% read the ts file produce by section flux to get the fluxes trought the
% boundaries
...
mpb_n_wc   =totals(:,25)./(1000*1000*1000); % 17 is the column  number corresponding to the data
dip_wc     =totals(:,3)./(1000*1000*1000); % 17 is the column  number corresponding to the data
phyd_n_wc  =totals(:,26)./(1000*1000*1000); % 17 is the column  number corresponding to the data
...
mpb_n_sed           =totals_sed(:,17)./(1000*1000*1000); % 17 is
phyd_n_sed          =totals_sed(:,22)./(1000*1000*1000); % 17 is the column  number corresponding to the data
...
phys_prod_n_sed   =totals_sed(:,19)./(1000*1000*1000);
phyl_prod_n_sed   =totals_sed(:,18)./(1000*1000*1000);
zoos_rem_n_sed    =totals_sed(:,21)./(1000*1000*1000);
zool_rem_n_sed    =totals_sed(:,20)./(1000*1000*1000);
...
%--------------------------------------------------------------------------
%--------------------------------------------------------------------------
% plot the total biomass in the model domain
%--------------------------------------------------------------------------
%--------------------------------------------------------------------------
%--------------------------------------------------------------------------
figure
