 ...
 *
 *  File: model/lib/grid/misc/preader.c
 *  
 *  Description: Serial "reader" of the output point locations
 *
 *  Designed to be able to read one output point at a time, either
 *  from a file or from a virtual nx x ny grid.  Allows to interpolate
 *  on a point-by-point basis and therefore avoids allocating the
 *  whole output array in memory.
 *
 *  Copyright:
 ...
 *
 *  $Id: preader.c 5839 2018-06-28 03:38:07Z riz008 $
 *
 */
